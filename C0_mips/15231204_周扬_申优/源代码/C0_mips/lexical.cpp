...
int error(int e)                    ////////////////////////////初步的报错
{
	...
	case 3: cout << "error: " << " in line:" << line_num << " Missing \" in the string or illeagal character" << endl;     break;
	...
	case 6: cout << "error: " << " in line:" << line_num << " Missing type identification: int|char|void or the const definition is in wrong position" << endl;      break;
	...
	case 12: cout << "error: " << " in line:" << line_num << " Missing semi: ; in the former line" << endl;      break;
